...
VOICE_DESIGN_TEST_SENTENCES = {
    ...
    "female": (
        "She walked through the moonlit garden, listening as fallen leaves whispered beneath each careful step."
    ),
    "other": ("The library was vast and silent, filled with old paper, dust, and half-forgotten memories."),
}
